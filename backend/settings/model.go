...
func ensureDefaultSettings() {
	...
	if len(s.Trades.Columns) == 0 {
		s.Trades.Columns = []Column{
			...
			{Name: "quoteFee", Label: "Quote Fee", Visible: true, Sortable: true, Width: "160px"},
			{Name: "quoteFeePriceC", Label: "Quote Fee Price C", Visible: true, Sortable: true, Width: "100px"},
			{Name: "quoteFeeC", Label: "Quote Fee C", Visible: true, Sortable: true, Width: "100px"},
			{Name: "quoteFeeCurrency", Label: "Quote Fee Currency", Visible: true, Sortable: true, Width: "100px"},
